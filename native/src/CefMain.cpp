...
#if defined(_WIN32)
    const std::string subprocess_path = exe_dir + "/SubCefTest2.exe";
#elif defined(__APPLE__)
    const std::string subprocess_path = exe_dir + "/SubCefTest2 Helper.app/Contents/MacOS/SubCefTest2 Helper";
#else
    const std::string subprocess_path = exe_dir + "/SubCefTest2";
#endif
